...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { contributor: @contribution.contributor, email: @contribution.email, text: @contribution.text }
    end
  ...
  test "should update contribution" do
    patch :update, id: @contribution, contribution: { contributor: @contribution.contributor, email: @contribution.email, text: @contribution.text }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
